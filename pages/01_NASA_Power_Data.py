...
st.warning(st.markdown("This tool is a GIS-formatting utility for the [NASA POWER API](google.com). For real-time critical safety decisions, always cross-reference with NASA POWER Official."))
