...
st.warning("This tool is a GIS-formatting utility for the NASA POWER API. For real-time critical safety decisions, always cross-reference with NASA POWER Official.")
